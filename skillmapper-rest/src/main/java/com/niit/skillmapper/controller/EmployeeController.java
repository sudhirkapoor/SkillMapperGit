...
public class EmployeeController {
	...
	public ResponseEntity<Object> getEmployeeByLocation(@PathVariable("location") String location,
			HttpSession session) {
		List<Employee> employeeList = null;
		if (session.getAttribute("loggedInUser") != null) {
	...
	public ResponseEntity<Object> getEmployeeByDepartment(@PathVariable("department") String department,
		...
		if (session.getAttribute("loggedInUser") != null) {
			...
			if (employeeList == null)
				...
				return new ResponseEntity<Object>(employeeDAOInterface.getEmployeeByLocation(department),
						HttpStatus.OK);
			}
		} else {
			return new ResponseEntity<Object>("You are Not Authorized, Please login first", HttpStatus.UNAUTHORIZED);
...
*/
	...
	public ResponseEntity<Object> getAllEmployeesByMultipleSkillName(@PathVariable("skillname") String skillname,
			HttpSession session) {
		List<Employee> employeeList = null;
